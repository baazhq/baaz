...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TenantAppSize) DeepCopyInto(out *TenantAppSize) {
	*out = *in
	if in.AppSizes != nil {
		in, out := &in.AppSizes, &out.AppSizes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TenantAppSize.
func (in *TenantAppSize) DeepCopy() *TenantAppSize {
	if in == nil {
		return nil
	}
	out := new(TenantAppSize)
	in.DeepCopyInto(out)
	return out
}
