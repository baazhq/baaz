...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPTenantInfra) DeepCopyInto(out *HTTPTenantInfra) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPTenantInfra.
func (in *HTTPTenantInfra) DeepCopy() *HTTPTenantInfra {
	if in == nil {
		return nil
	}
	out := new(HTTPTenantInfra)
	in.DeepCopyInto(out)
	return out
}
