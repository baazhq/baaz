...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AwsAuthRef) DeepCopyInto(out *AwsAuthRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AwsAuthRef.
func (in *AwsAuthRef) DeepCopy() *AwsAuthRef {
	if in == nil {
		return nil
	}
	out := new(AwsAuthRef)
...
func (in *CloudInfraStatus) DeepCopyInto(out *CloudInfraStatus) {
	*out = *in
	in.AwsCloudInfraConfigStatus.DeepCopyInto(&out.AwsCloudInfraConfigStatus)
}
...
func (in *DataPlaneStatus) DeepCopyInto(out *DataPlaneStatus) {
	*out = *in
	in.CloudInfraStatus.DeepCopyInto(&out.CloudInfraStatus)
...
func (in *TenantApplicationConfig) DeepCopy() *TenantApplicationConfig {
	...
	out := new(TenantApplicationConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TenantsInfraStatus) DeepCopyInto(out *TenantsInfraStatus) {
	*out = *in
	if in.NodegroupStatus != nil {
		in, out := &in.NodegroupStatus, &out.NodegroupStatus
		*out = make(map[string]NodegroupStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *TenantsSpec) DeepCopyInto(out *TenantsSpec) {
	*out = *in
	if in.TenantConfig != nil {
		...
		*out = make([]TenantApplicationConfig, len(*in))
		copy(*out, *in)
	}
